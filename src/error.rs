...
pub enum GCError {
    ...
    ServiceLeaseLimit { service_id: String, current: usize, max: usize },
    
    #[error("Unauthorized access to lease: {lease_id} by service: {service_id}")]
    UnauthorizedAccess { lease_id: String, service_id: String },
